...
list_of_ana = (String) mapSession.getAttribute("list");
mapSession.removeAttribute("list");

Vector list = new Vector();
StringTokenizer tokens2 = new StringTokenizer(list_of_ana, ",");
