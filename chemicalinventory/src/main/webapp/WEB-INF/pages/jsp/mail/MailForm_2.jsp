...
-->
  ...
  <%
	  ...
	  String to_username = request.getParameter("user");
  %>
  ...
  {%>
    <CENTER>
    	...
    	<tr>
	      ...
	      <input class="submit" type="submit" value="Send Mail" onclick="this.form.action='<%=Attributes.JSP_BASE%>?action=mail2&code1=yes'">
  ...
  if (request.getParameter("code1")!=null) 
  {
	  ...
	  String status = mail.sendMail("single_user");
	  out.print(status);
	  %><br>
