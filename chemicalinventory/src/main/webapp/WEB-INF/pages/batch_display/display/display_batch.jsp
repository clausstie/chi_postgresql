...
-->
  ...
  <span class="textboxadm">
   ...
   <center>
   	<form method="post" action="<%=Attributes.D_BATCH_BASE%>?action=view_batch&code1=yes" name="resource_form" onsubmit="return validateForm(this)">
    ...
    if (request.getParameter("code1") != null)
 	{
 		...
 		if(check)
 		{
			...
			<img src="<%=Attributes.IMAGE_FOLDER%>/Divider1a800.png">
		 	  <center>
				<form method="post" action="<%=Attributes.D_BATCH_BASE%>?action=view_batch&code1=yes">
		...
		{%>
		 <h2>Display Batch - Error Status</h2>
		<img src="<%=Attributes.IMAGE_FOLDER%>/Divider1a800.png">
		<br/>
